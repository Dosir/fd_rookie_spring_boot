...
public class DataSourceConfig {
    ...
    @Autowired
    private Environment env;  // Environment 可以很方便的获取配置文件中的参数

    // DataSourceProperties和 @ConfigurationProperties(prefix = "spring.datasource.master")配合使用，
    // 将配置文件中的配置数据自动封装到实体类DataSourceProperties中
    @Autowired
    ...
    /**
     *  构造多数据源连接池
     *  Master 数据源连接池采用 masterDataSource
     *  Slave  数据源连接池采用 slaveDataSource
     * @param master
     * @param slave
     * @return
     */
    ...
    public DynamicDataSource dataSource(@Qualifier("masterDataSource") DataSource master,
        ...
        dataSource.setDefaultTargetDataSource(slave);// 默认的datasource设置为slaveDataSource
